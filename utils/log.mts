...
import { Template } from '../types/log/template/index.mjs';
import { ChannelTemplateInfo, MessageTemplateInfo, ModerateTemplateInfo, validateChannelTemplateInfo, validateMessageTemplateInfo, validateModerateTemplateInfo } from '../types/log/template/info.mjs';
import { validateBanPunishmentInfo, validateKickPunishmentInfo, validateLockPunishmentInfo, validateMessageDeletePunishmentInfo, validateMessageEditPunishmentInfo, validatePhishPunishmentInfo, validatePurgePunishmentInfo, validateTimeoutPunishmentInfo, validateUnBanPunishmentInfo, validateUnlockPunishmentInfo, validateUnTimeoutPunishmentInfo } from '../types/log/info/index.mjs';
